/* ============================================================
   Screen 0: LOGIN — Sunny. brand identity
   Full-bleed, no sidebar. Editorial split: left brand, right form.
   ============================================================ */
      ...
      <div className="login-form-wrap">
        <div className="login-form">
          ...
          <div className="login-fields">
            ...
            <div className="login-field">
              <label>이메일</label>
              <input className="field-input" type="email" defaultValue="nextsunny@gmail.com" placeholder="you@example.com"/>
            </div>
            <div className="login-field">
              <label>
                비밀번호
            ...
            {mode === "signup" && (
              <div className="login-field">
                ...
                <input className="field-input" type="text" placeholder="SUNNY-XXXX-XXXX" defaultValue=""/>
              </div>
            )}
            ...
            {mode === "login" && showInvite && (
              <div className="login-field">
                ...
                <input className="field-input" type="text" placeholder="SUNNY-XXXX-XXXX" defaultValue="" autoFocus/>
              </div>
            )}
          </div>
