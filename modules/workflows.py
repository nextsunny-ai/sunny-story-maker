...
def common_writing_fields(extra: list = None, exclude: list = None) -> list:
    ...
    base = [
        ...
        {"key": "pov_custom", "label": "↪ 직접 입력", "type": "text",
        ...
        {"key": "era_custom", "label": "↪ 직접 입력", "type": "text",
        ...
        {"key": "space_custom", "label": "↪ 직접 입력", "type": "text",
        ...
        {"key": "structure_custom", "label": "↪ 직접 입력", "type": "text",
